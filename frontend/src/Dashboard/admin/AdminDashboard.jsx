...
const AdminDashboard = () => {
    ...
    const [tab, setTab] = useState('myDoctors')
            ...
            }
            {
                !loading && !error && <div className="grid md:grid-cols-3 gap-10">
                    ...
                    <div className="md:col-span-2 md:px-[30px]">
                        <div>
                            <button 
                                onClick={()=>setTab('myDoctors')} 
                                className={`${tab==='myDoctors' && 'bg-primaryColor text-white font-normal'} p-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}
                            >
                                MyDoctors
                            </button>
                            ...
                            <button 
                                ...
                                className={`${tab==='reviews' && 'bg-primaryColor text-white font-normal'} p-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}
                            >
                                Reviews
                            </button>
                        </div>
                        {
                            tab==='myDoctors' && <MyDoctors/>
                        }
                        {
