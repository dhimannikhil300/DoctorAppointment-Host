...
const Profile = ({doctorData}) => {
    ...
    const handleTimeSloatChange = (event, index) => {
        handleReusableInputChangeFunction('timeSlots', index, event)
    }

    const deleteTimeSloat = (e, index)=>{
        e.preventDefault()
        ...
        <form>
            ...
            <div className="mb-5">
                <div className="grid grid-cols-3 gap-5 mb-[30px]">
                    ...
                    <div>
                        <p className="form__label">Specializarion*</p>
                        ...
                        >
                            ...
                            <option value="dernatologist">Dernatologist</option>
                        </select>
                    </div>
            ...
            <div className="mb-5">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                            <div>
                                ...
                                <select 
                                    ...
                                    value={item.day} 
                                    className="form__input py-3.5"
                                    onChange={e=>handleTimeSloatChange(e, index)}
                                >
                                    <option value="" >Select</option>
                            ...
                            <div className="flex items-center">
                                <button onClick={e=>deleteTimeSloat(e, index)} className="bg-red-600 p-2 rounded-full text-white text-[18px] cursor-pointer mt-6">
                                    <AiOutlineDelete />
                                </button>
                            </div>
                        </div>
                ...
                <button onClick={addTimeSloat} className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">
                    Add TimeSlot
                </button>
            </div>
